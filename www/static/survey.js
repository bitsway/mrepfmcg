...
function check_user() {
	...
	var apipath_base_photo_dm='http://e2.businesssolutionapps.com/mrepmacrocable/syncmobile/dmpath?CID='+cid +'&HTTPPASS=e99business321cba'
									 ...
									 success: function(result) {
											...
											if (result==''){
												...
												if (resultArray[0]=='FAILED'){
													...
													var product_tbl_doc_campaign='<table border="0"  cellpadding="0" cellspacing="0" style="border-radius:5px;">';
...
function marketNext() {
	...
	if(market_name=='' || market_name==0){
			...
			//$("#err_market_next").html(localStorage.base_url+'getMarketClientList?cid='+localStorage.cid+'&rep_id='+localStorage.user_id+'&rep_pass='+localStorage.user_pass+'&synccode='+localStorage.synccode+'&market_id='+market_Id);
			// ajax-------
			$.ajax({
				 type: 'POST',
...
//--------------------Item Search End----------------
//--------------------Item Search Doctor Campaign Start----------------
...
//--------------------Item Search Doctor Campaign End----------------
//--------------------cart Start----------------
function cart_data() {	
	//alert ('nadira');
